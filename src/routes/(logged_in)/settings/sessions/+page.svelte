...
<style>
    ...
    :global(.platform-icon.expand) {
        clip-path: polygon(0 0, 133% 0, 100% 100%, 0 100%) !important;
        transition: clip-path 0.5s ease-in-out;
    }

    :global(.platform-icon.retract) {
        clip-path: polygon(-66% 0, 0 0, -33% 100%, -66% 100%) !important;
        transition: clip-path 0.5s ease-in-out;
    }
    ...
    :global(.client-icon.expand) {
        clip-path: polygon(0 0, 100% 0, 100% 100%, -33% 100%) !important;
        transition: clip-path 0.5s ease-in-out;
    }

    :global(.client-icon.retract) {
        clip-path: polygon(133% 0, 166% 0, 166% 100%, 100% 100%) !important;
        transition: clip-path 0.5s ease-in-out;
    }
